    ...
    "validation_summary": {
        ...
        "validation_results": {
            "file_format": {
                ...
                "issues": [
                    {
                        "filename": "TH_PRCH_${DATE_PATTERN}120000_FORMAT_ISSUE.csv",
                        "issue": "invalid_csv_format",
                        "severity": "critical"
                    },
                    {
                        "filename": "TH_PROMPRCH_${DATE_PATTERN}130000_FORMAT_ISSUE.csv",
            ...
            "required_fields": {
                ...
                "issues": [
                    {
                        "filename": "TH_PRCH_${DATE_PATTERN}140000_MISSING_FIELDS.csv",
                        "issue": "missing_required_field_price",
                        "severity": "critical"
                    },
                    {
                        "filename": "TH_PROMPRCH_${DATE_PATTERN}150000_MISSING_FIELDS.csv",
            ...
            "data_types": {
                ...
                "issues": [
                    {
                        "filename": "TH_PRCH_${DATE_PATTERN}160000_TYPE_ISSUE.csv",
                        "issue": "invalid_price_format",
                        "severity": "warning"
                    },
                    {
                        "filename": "TH_PROMPRCH_${DATE_PATTERN}170000_TYPE_ISSUE.csv",
            ...
            "file_size": {
                ...
                "issues": [
                    {
                        "filename": "TH_PRCH_${DATE_PATTERN}180000_SIZE_ISSUE.csv",
    ...
    cat > "$AUTO_FEEDBACK_DIR/mock_transfer_tracking_results.json" << EOF
{
    ...
    "transfer_summary": {
        "1p_to_soa": {
            ...
            "failed_files": [
                {
                    "filename": "TH_PRCH_${DATE_PATTERN}190000.csv",
        ...
        "soa_to_rpm": {
            ...
            "failed_files": [
                {
                    "filename": "TH_PROMPRCH_${DATE_PATTERN}200000.csv",
    ...
    cat > "$AUTO_FEEDBACK_DIR/mock_monitoring_results.json" << EOF
{
    ...
    "detection_summary": {
        "mismatches": {
            ...
            "affected_files": [
                "TH_PRCH_${DATE_PATTERN}210000_MISMATCH.csv",
                "TH_PROMPRCH_${DATE_PATTERN}220000_MISMATCH.csv"
            ]
        },
        "missing_files": {
            "total_missing": 5,
            ...
            "critical_missing": 2,
            "affected_files": [
                "TH_PRCH_${DATE_PATTERN}230000.csv",
                "TH_PROMPRCH_${DATE_PATTERN}240000.csv"
            ]
        },
        "corrupt_files": {
            "total_corrupt": 4,
            ...
            "too_large": 1,
            "affected_files": [
                "TH_PRCH_${DATE_PATTERN}250000_CORRUPT.csv"
            ]
        },
        "duplicates": {
            "total_duplicates": 6,
            ...
            "affected_files": [
                "TH_PRCH_${DATE_PATTERN}260000.csv"
            ]
        },
    ...
    "flagged_summary": {
        ...
        "flag_categories": {
            "critical": {
                ...
                "files": [
                    "TH_PRCH_${DATE_PATTERN}270000.csv",
                    "TH_PROMPRCH_${DATE_PATTERN}280000.csv"
                ]
            },
            "warning": {
                "count": 6,
