...
# file names, keeping only the timestamp format like TH_PRCH_20250819051805.ods
#
# =============================================================================
...
echo -e "${YELLOW}💡 All files now use format: TH_PRCH_20250819051805.ods${NC}"
...
echo -e "  • Files now use only timestamp: TH_PRCH_\${DATE_PATTERN}\${timestamp}.ods"
echo -e "  • Same for promotion files: TH_PROMPRCH_\${DATE_PATTERN}\${timestamp}.ods"
