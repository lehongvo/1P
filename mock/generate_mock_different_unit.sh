...
generate_price_files() {
    ...
    for i in $(seq 1 $TOTAL_FILES); do
        ...
        location3=${locations[$((RANDOM % ${#locations[@]}))]}  # Random location for third row
...
insert_single_price_record() {
    ...
    # Generate random status: 90% chance of status=1, 10% chance of status=3
    local status=1
