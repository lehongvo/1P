...
generate_missing_required_fields_correctable() {
    ...
    missing_fields_price1="TH_PRCH_${DATE_PATTERN}${timestamp}.ods"
...
EOF
    ...
    missing_fields_price2="TH_PRCH_${DATE_PATTERN}${timestamp}.ods"
...
EOF
    ...
    timestamp=$(printf "%02d%02d%02d" $((7 + RANDOM % 6)) $((RANDOM % 60)) $((RANDOM % 60)))
    missing_fields_promo1="TH_PROMPRCH_${DATE_PATTERN}${timestamp}.ods"
...
generate_data_type_mismatch_correctable() {
    ...
    timestamp=$(printf "%02d%02d%02d" $((8 + RANDOM % 5)) $((RANDOM % 60)) $((RANDOM % 60)))
    data_type_price1="TH_PRCH_${DATE_PATTERN}${timestamp}.ods"
...
EOF
    ...
    timestamp=$(printf "%02d%02d%02d" $((9 + RANDOM % 4)) $((RANDOM % 60)) $((RANDOM % 60)))
    data_type_price2="TH_PRCH_${DATE_PATTERN}${timestamp}.ods"
...
EOF
    ...
    timestamp=$(printf "%02d%02d%02d" $((10 + RANDOM % 3)) $((RANDOM % 60)) $((RANDOM % 60)))
    data_type_promo1="TH_PROMPRCH_${DATE_PATTERN}${timestamp}.ods"
...
generate_format_issues_correctable() {
    ...
    timestamp=$(printf "%02d%02d%02d" $((11 + RANDOM % 2)) $((RANDOM % 60)) $((RANDOM % 60)))
    format_issue_price1="TH_PRCH_${DATE_PATTERN}${timestamp}.ods"
...
EOF
    ...
    timestamp=$(printf "%02d%02d%02d" $((12 + RANDOM % 1)) $((RANDOM % 60)) $((RANDOM % 60)))
    format_issue_price2="TH_PRCH_${DATE_PATTERN}${timestamp}.ods"
...
EOF
    ...
    timestamp=$(printf "%02d%02d%02d" $((13 + RANDOM % 1)) $((RANDOM % 60)) $((RANDOM % 60)))
    format_issue_promo1="TH_PROMPRCH_${DATE_PATTERN}${timestamp}.ods"
...
generate_size_issues_correctable() {
    ...
    timestamp=$(printf "%02d%02d%02d" $((14 + RANDOM % 1)) $((RANDOM % 60)) $((RANDOM % 60)))
    large_file_price="TH_PRCH_${DATE_PATTERN}${timestamp}.ods"
    ...
    timestamp=$(printf "%02d%02d%02d" $((15 + RANDOM % 1)) $((RANDOM % 60)) $((RANDOM % 60)))
    small_file_price="TH_PRCH_${DATE_PATTERN}${timestamp}.ods"
...
generate_duplicate_issues_correctable() {
    ...
    timestamp=$(printf "%02d%02d%02d" $((16 + RANDOM % 1)) $((RANDOM % 60)) $((RANDOM % 60)))
    duplicate_price1="TH_PRCH_${DATE_PATTERN}${timestamp}.ods"
...
EOF
    ...
    timestamp=$(printf "%02d%02d%02d" $((17 + RANDOM % 1)) $((RANDOM % 60)) $((RANDOM % 60)))
    duplicate_promo1="TH_PROMPRCH_${DATE_PATTERN}${timestamp}.ods"
...
generate_transfer_retry_correctable() {
    ...
    timestamp=$(printf "%02d%02d%02d" $((18 + RANDOM % 1)) $((RANDOM % 60)) $((RANDOM % 60)))
    retry_price1="TH_PRCH_${DATE_PATTERN}${timestamp}.ods"
...
EOF
    ...
    timestamp=$(printf "%02d%02d%02d" $((19 + RANDOM % 1)) $((RANDOM % 60)) $((RANDOM % 60)))
    retry_promo1="TH_PROMPRCH_${DATE_PATTERN}${timestamp}.ods"
...
upload_auto_correction_files() {
    ...
    for file in $AUTO_CORRECTION_DIR/TH_PRCH_${DATE_PATTERN}${timestamp}.ods; do
        if [ -f "$file" ]; then
    ...
    for file in $AUTO_CORRECTION_DIR/TH_PROMPRCH_${DATE_PATTERN}${timestamp}.ods; do
        if [ -f "$file" ]; then
...
simulate_partial_corrections() {
    ...
    docker exec $DOCKER_CONTAINER bash -lc "
        ...
        count=0
        for f in $SFTP_1P_PRICE/TH_PRCH_${DATE_PATTERN}${timestamp}.ods; do
            if [ -f \"\$f\" ]; then
                base=\$(basename \"\$f\")
                cp \"\$f\" $SFTP_SOA_PRICE/
        ...
        count=0
        for f in $SFTP_1P_PROMOTION/TH_PROMPRCH_${DATE_PATTERN}${timestamp}.ods; do
            if [ -f \"\$f\" ]; then
                base=\$(basename \"\$f\")
    ...
    docker exec $DOCKER_CONTAINER bash -lc "
        ...
        count=0
        for f in $SFTP_SOA_PRICE/TH_PRCH_${DATE_PATTERN}${timestamp}.ods; do
            if [ -f \"\$f\" ]; then
                base=\$(basename \"\$f\")
