    ...
    cat > "$FILE_TRACKING_DIR/mock_1p_file_listing.json" << EOF
{
    ...
    "directories": {
        "price": {
            ...
            "files": [
                {
                    "filename": "TH_PRCH_${DATE_PATTERN}080000_SUCCESSFUL.csv",
                    "size": 1024,
                ...
                {
                    "filename": "TH_PRCH_${DATE_PATTERN}090000_DELAYED.csv",
                    "size": 2048,
                ...
                {
                    "filename": "TH_PRCH_${DATE_PATTERN}100000.csv",
                    "size": 4096,
                ...
                {
                    "filename": "TH_PRCH_${DATE_PATTERN}110000.csv",
                    "size": 8192,
                ...
                {
                    "filename": "TH_PRCH_${DATE_PATTERN}120000_ORPHANED_1P.csv",
                    "size": 512,
        ...
        "promotion": {
            ...
            "files": [
                {
                    "filename": "TH_PROMPRCH_${DATE_PATTERN}130000_SUCCESSFUL.csv",
                    "size": 1536,
                ...
                {
                    "filename": "TH_PROMPRCH_${DATE_PATTERN}140000.csv",
                    "size": 3072,
                ...
                {
                    "filename": "TH_PROMPRCH_${DATE_PATTERN}150000_PENDING.csv",
                    "size": 6144,
    ...
    "directories": {
        "price": {
            ...
            "files": [
                ...
                {
                    "filename": "TH_PRCH_${DATE_PATTERN}200000_ORPHANED_SOA.csv",
                    "size": 1024,
    ...
    cat > "$FILE_TRACKING_DIR/scenario_metadata_mismatches.json" << EOF
{
    ...
    "input_data": {
        "test_files": [
            ...
            {
                "filename": "TH_PRCH_${DATE_PATTERN}160000_TIMESTAMP_ISSUE.csv",
                "1p_metadata": {
                    "size": 1024,
