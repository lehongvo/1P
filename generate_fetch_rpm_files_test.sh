...
generate_pending_files_scenarios() {
    ...
    for i in {1..3}; do
        ...
        pending_price="TH_PRCH_${DATE_PATTERN}${timestamp}.ods"
...
EOF
    ...
    for i in {1..2}; do
        ...
        pending_promo="TH_PROMPRCH_${DATE_PATTERN}${timestamp}.ods"
...
generate_failed_processing_scenarios() {
    ...
    for i in {1..2}; do
        ...
        failed_price="TH_PRCH_${DATE_PATTERN}${timestamp}.ods"
...
EOF
    ...
    failed_promo="TH_PROMPRCH_${DATE_PATTERN}${timestamp}.ods"
...
generate_file_status_scenarios() {
    ...
    for i in "${!status_indicators[@]}"; do
        ...
        status_file="TH_PRCH_${DATE_PATTERN}${timestamp}.ods"
...
generate_performance_scenarios() {
    ...
    for i in {1..30}; do
        ...
        perf_file="TH_PRCH_${DATE_PATTERN}${timestamp}.ods"
