...
generate_invalid_price_datatypes() {
    ...
    invalid_price_numeric="TH_PRCH_${DATE_PATTERN}${timestamp}.csv"
    ...
    second=$((RANDOM % 60))
    timestamp=$(printf "%02d%02d%02d" $hour $minute $second)
    invalid_start_date="TH_PRCH_${DATE_PATTERN}${timestamp}.csv"
    ...
    second=$((RANDOM % 60))
    timestamp=$(printf "%02d%02d%02d" $hour $minute $second)
    invalid_end_date="TH_PRCH_${DATE_PATTERN}${timestamp}.csv"
...
generate_invalid_promotion_datatypes() {
    ...
    second=$((RANDOM % 60))
    timestamp=$(printf "%02d%02d%02d" $hour $minute $second)
    invalid_discount="TH_PROMPRCH_${DATE_PATTERN}${timestamp}.csv"
    ...
    second=$((RANDOM % 60))
    timestamp=$(printf "%02d%02d%02d" $hour $minute $second)
    invalid_promo_dates="TH_PROMPRCH_${DATE_PATTERN}${timestamp}.csv"
